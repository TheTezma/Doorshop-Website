...
> We are proud to release <strong>Version 3.0.0-BETA</strong> after receiving an overwhelming response from our customers. The new version includes several new improvements as below.

1. Default Skin is upgraded with pro features. (Premium Default+ Skin becomes Default skin)
	* Selected Filters.
	* Separate Gallery for item (Album) feature.
	* Pagination support.
2. PrettyPhoto Lightbox is upgraded with pro features. (Premium PrettyPhoto Lightbox becomes Default lightbox)
	* <a href="http://www.addthis.com/">Addthis</a> Social widget support.
	* PrettyPhoto Customization via Options.
3. Redux Framework is used for Options Management.
4. Plugin is Translation ready now.
5. W3C validated.

> You are welcome to <a href="http://bit.ly/wp-gallery-3-beta">Download</a> and test drive the new version and report us any issues you come across through the wordpress support forum.
> 
