...
function doc_helper( $title, $url, $class = null ) {
	...
	__( 'See %s configuration tips in the impleCode documentation', 'post-type-x' ), $title ) . '.</div>
		<div class="doc-button"><a href="https://implecode.com/docs/post-type-x/core/' . $url . '/?cam=catalog-docs-box&key=' . $url . '"><input class="doc_button classic-button" type="button" value="' . __( 'See in Docs', 'post-type-x' ) . '"></a></div>
		<a title="' . __( 'Click the button to visit impleCode documentation', 'post-type-x' ) . '" href="https://implecode.com/docs/post-type-x/core/' . $url . '/?cam=catalog-docs-box&key=' . $url . '" class="background-url"></a>
		</div></div>';
	echo $helper;
}
