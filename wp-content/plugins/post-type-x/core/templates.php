...
//$box_content .= '<p>' . __( 'Please use the buttons below to let the script know if the Automatic Advanced Integration is done right.', 'post-type-x' ) . '</p>';
			$box_content			 .= '<p class="wp-core-ui" style="margin-top: 20px;"><button class="button-primary start_section">' . __( 'Start', 'post-type-x' ) . '</button></p>';
			...
			$box_content			 .= '<tr><td colspan="2"><p style="margin-bottom: 5px">' . sprintf( __( 'Use %1$swidth%2$s to change the product page horizontal size, %1$spadding%2$s to generate space around the content and %1$sbackground%2$s to match your theme color', 'post-type-x' ), '<strong>', '</strong>' ) . ':</p></td></tr>';
	...
	margin-left: -23px;}</style>';
			...
			$box_content .= '<p>' . __( 'If you are a developer or would like to have full control on the product pages templates we still recommend to proceed with manual integration.', 'post-type-x' ) . '</p>';
